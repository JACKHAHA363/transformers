...
ROBIN_PRETRAINED_CONFIG_ARCHIVE_MAP = {
...
class RobinConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_image_embed_layernorm = use_image_embed_layernorm
        self.adapter_downsample_factor = adapter_downsample_factor
